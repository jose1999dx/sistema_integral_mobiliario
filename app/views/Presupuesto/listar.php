    ...
    <div class="header-section">
        ...
        <div class="header-actions">
            ...
            <a href="<?php echo BASE_URL; ?>/public/index.php?url=dashboard" class="btn-back-dashboard">
             ...
             <!-- ✅ NUEVO BOTÓN: Reportes de Rentabilidad -->
    <a href="<?php echo BASE_URL; ?>/index.php?url=presupuesto/rentabilidad" class="btn-create" style="background-color: #6f42c1;">
        <span>📊</span> Reportes de Rentabilidad
    </a>
